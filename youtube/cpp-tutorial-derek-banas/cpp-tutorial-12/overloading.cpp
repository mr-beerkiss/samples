...
int main()
{
  ...
  printf("box 3 length = %.2f, width = %.2f and breadth = %.2f\n", box3[0], box3[1], box3[2]);

  // This is an alternative way to setting `std::cout.setf(std::ios::boolalpha)
  // kind of dirty if you ask me but good to know.
  std::cout << std::boolalpha;

  std::cout << "Is box3 equal to box2: " << (box3 == box2) << "\n";

  std::cout << "Is box1 > than box3: " << (box > box2) << "\n";
